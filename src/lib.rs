...
mod tests {
    ...
    fn it_works() {
        ...
        assert_eq!(curve.pt(U512::zero(), U512::zero()), generator * order);
    }
    ...
    fn diffie() {
        ...
        let d_a = U512::random_in_range(U512::from_u64(1), order, &mut rng);
        let d_b = U512::random_in_range(U512::from_u64(1), order, &mut rng);

        let thing1 = generator * d_a;
        let thing2 = generator * d_b;
